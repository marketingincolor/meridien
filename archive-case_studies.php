		    ...
		    <main class="main small-12 medium-12 cell" role="main">
				...
				<div class="grid-x grid-padding-x">
					...
					<div class="cell small-12 text-center">
						...
						<?php echo do_shortcode('[searchandfilter hide_empty="0" fields="indications" types="select,multiselect" headings="Indication" submit_label="Filter" post_types="case_studies" class="studies-list"]'); ?>
