 ...
 */
$indication = get_term_by( 'slug', get_query_var( 'term' ), get_query_var( 'taxonomy' ) ); 
get_header(); ?>
		    ...
		    <main class="main small-12 medium-12 cell" role="main">
				...
				<div class="grid-x grid-padding-x">
					<div class="cell small-12 text-center">
						<h2 class="page-lead semi-font blue">Current Studies - <?php echo $indication->name;?></h2>
					</div>
					<div class="cell small-12 text-center" style="display:none;">
